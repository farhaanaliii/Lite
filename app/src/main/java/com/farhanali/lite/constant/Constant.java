...
public class Constant {
	...
	public static final String PREF_KEY_IS_DESKTOP = "pref_is_desktop";
	public static final String PREF_KEY_USER_AGENT = "pref_user_agent";
	public static final String PREF_KEY_CUSTOM_USER_AGENT = "pref_custom_user_agent";
	public static final String PREF_KEY_JAVASCRIPT = "pref_javascript";
